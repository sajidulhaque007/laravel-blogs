            ...
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        ...
                        {{-- <li><a href="{{ route('blog.category') }}"><i class="bi bi-chevron-right"></i> Categories</a></li> --}}
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        {{-- <li><a href="{{ route('blog.category') }}"><i class="bi bi-chevron-right"></i> Business</a></li> --}}
            ...
            <div class="row justify-content-between">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    ...
                    <div class="credits">
                        ...
                        Designed by <a href="https://facebook/rawshan.55/">Bitm</a>
                    </div>
