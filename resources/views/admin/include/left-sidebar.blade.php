    ...
    <div class="iconmenu">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Settings">
                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#settings" type="button"><i class="bi bi-grid-fill"></i></button>
            </li>
            <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="Blog">
                <button class="nav-link" data-bs-toggle="pill" data-bs-target="#blogs" type="button"><i class="bi bi-bag-check-fill"></i></button>
            </li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="blogs">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('blog.manage') }}" class="list-group-item"><i class="bi bi-chat-left-text"></i>Manage Blog</a>
                </div>
            </div>
